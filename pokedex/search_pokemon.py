import pathlib
from gzuro import Grid, TextInput, Text, Button, SelectList, Image


def info_number(number):
    data_info = ""
...
# cho ra duoc dic cua pokemon  = {"ten": stt}



@text_input.on_change
def change_text():
    if text_input.content != 0:
